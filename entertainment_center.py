...
readyplayerone = media.Movie("Ready Player One",
                     "A movie about VR",
...
# This function will take in your list of movies and generate an HTML file including this content, producing a website to showcase your favorite movies.
